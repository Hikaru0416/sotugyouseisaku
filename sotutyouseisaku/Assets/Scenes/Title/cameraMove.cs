...
public class cameraMove : MonoBehaviour
{
    ...
    //カメラの移動量
    [SerializeField, Range(0.1f, 400.0f)]
    private float _positionStep = 39000.0f;
    ...
    private void CameraRotationMouseControl()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            _presentCamRotation.y = _camTransform.transform.eulerAngles.x;
            _presentCamRotation.x = _camTransform.transform.eulerAngles.y;
        }
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            float eulerY = _presentCamRotation.x + -x * _mouseSensitive;
            float eulerX = _presentCamRotation.y + y * _mouseSensitive;
